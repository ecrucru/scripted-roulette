...
REM ===== Options
set cpp_opt=-3 -O2 -P -R- -RT- -c -w -n"../bin" -tW -u
set link_opt=-C -E50 -r -c -Gn -x -aa -L"../src/sr_tools"
set link_windows=kernel32.lib
set link_wx=wxmsw28_core.lib wxbase28.lib wxmsw28_adv.lib
set link_sr=ec_engine.obj ec_plot.obj sr_tools.lib http_prng.obj random.obj instruction.obj sequence.obj roulette.obj table.obj frame.obj main.obj
